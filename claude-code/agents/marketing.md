...
- **GEO**: optimaliseren voor AI-zoekmachines (ChatGPT, Gemini, Perplexity). Gestructureerde data (schema.org), autoriteit opbouwen via citeerbare content, FAQ-structuren, entity-based content
...
- **Concurrentieanalyse**: wat doen concurrenten in jouw sector
